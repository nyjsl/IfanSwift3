...
let categoryModelArray = [
    CategoryModel(
        title: "首页",
        backgroudImage: UIImage(named: "category_menu_home_bg")!,
    ...
    CategoryModel(
        title: "视频",
        backgroudImage: UIImage(named: "category_menu_video_bg")!,
    ...
    CategoryModel(
        title: "iSeed",
        backgroudImage: UIImage(named: "category_menu_iseed_bg")!,
    ...
    CategoryModel(
        title: "大声", backgroudImage: UIImage(named: "category_menu_dasheng_bg")!,
    ...
    CategoryModel(
        title: "数读",
        backgroudImage: UIImage(named: "category_menu_shudu_bg")!,
    ...
    CategoryModel(
        title: "评测",
        backgroudImage: UIImage(named: "category_menu_evaluation_bg")!,
    ...
    CategoryModel(
        title: "产品",
        backgroudImage: UIImage(named: "category_menu_product_bg")!,
    ...
    CategoryModel(
        title: "汽车",
        backgroudImage: UIImage(named: "category_menu_car_bg")!,
    ...
    CategoryModel(
        title: "商业",
        backgroudImage: UIImage(named: "category_menu_business_bg")!,
    ...
    CategoryModel(
        title: "访谈",
        backgroudImage: UIImage(named: "category_menu_interview_bg")!,
    ...
    CategoryModel(
        title: "图记",
        backgroudImage: UIImage(named: "category_menu_picture_bg")!,
    ...
    CategoryModel(
        title: "清单",
        backgroudImage: UIImage(named: "category_menu_list_bg")!,
